...
public class SearchPage {
    ...
    public void openSearch() {
        By toClick = wait.until(d ->
                findFirstVisible((AndroidDriver) d,
                        SEARCH_CONTAINER,
                        SEARCH_TAB,
                        SEARCH_CARD,
                        SEARCH_ACTION,
    ...
    public List<WebElement> resultTitles() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(RESULT_TITLE));
        return driver.findElements(RESULT_TITLE);
    }
    ...
    public void waitResultsDisappear() {
        wait.until(d -> d.findElements(RESULT_TITLE).isEmpty());
    }
    ...
    private Optional<By> findFirstVisible(AndroidDriver d, By... locators) {
